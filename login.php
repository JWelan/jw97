      ...
      <div class="container">
        <div class="row">
          <div align="center" class="col-lg-12">
             <form id="Login_details" action="Loginphp.php" method="post" class="citirental-form">
              <h2>
                Please login below:
              </h2>
              <?php 
              ...
              <br>
              <div id="buttonL">
                <button id="Login" type="submit" name="Login" placeholder="Login" class="btn btn-rent" >Login</button></br>
              </div>
